...
public struct Straint {
    let type: ConsraintTypeUnsafe
    let constraint: ConsraintAnchorUnsafe
    
    public init(straint: ConsraintTypeUnsafe, anchor: ConsraintAnchorUnsafe) {
        self.type = straint
        self.constraint = anchor
    }
}
...
public enum ConsraintAnchorUnsafe {
    ...
    var anchorY: NSLayoutYAxisAnchor? {
        ...
        case .left, .leftSafe, .right, .rightSafe, .centerX, .length, .ratio:
            return nil
        }
    }
    ...
    var anchorX: NSLayoutXAxisAnchor? {
        ...
        case .centerY, .top, .topSafe, .bottom, .bottomSafe, .length, .ratio:
            return nil
        }
    }
